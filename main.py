            ...
            <main class="row">
                    ...
                    <div class="col-4 text-center">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="w-100 btn btn-success btn-lg">Купить</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">Lorem ipsum dolor sit amet consectetur adipisicing
                                            elit. Consequuntur fugiat suscipit neque nesciunt facere distinctio, atque
                                            possimus, officia aspernatur corrupti maxime quia sunt deserunt repudiandae
                                            dolor. Accusantium obcaecati pariatur reprehenderit!</div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">Lorem ipsum dolor sit amet consectetur adipisicing
                                            elit. Consequuntur fugiat suscipit neque nesciunt facere distinctio, atque
                                            possimus, officia aspernatur corrupti maxime quia sunt deserunt repudiandae
                                            dolor. Accusantium obcaecati pariatur reprehenderit!Lorem ipsum dolor sit
                ...
                <div class="row">
                    <div class="col w-100">
                        <div class="card rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">Таблица товаров:</h4>
                            </div>
                            <table class="table">
                                <thead>
                                    <tr>
